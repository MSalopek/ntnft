...
import NtNftNtnftBlog from './nt-nft/ntnft.blog'
import NtNftNtnftNtnft from './nt-nft/ntnft.ntnft'
import NtNftNtnftPrivateblog from './nt-nft/ntnft.privateblog'
...
export default { 
  ...
  NtNftNtnftBlog: load(NtNftNtnftBlog, 'ntnft.blog'),
  NtNftNtnftNtnft: load(NtNftNtnftNtnft, 'ntnft.ntnft'),
  NtNftNtnftPrivateblog: load(NtNftNtnftPrivateblog, 'ntnft.privateblog'),
